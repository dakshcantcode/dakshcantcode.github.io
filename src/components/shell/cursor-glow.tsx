...
export function CursorGlow() {
  ...
  return (
    <motion.div
      ...
      className="pointer-events-none fixed left-0 top-0 z-[5] size-[360px] rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.55),transparent_62%)] mix-blend-soft-light"
    />
  );
}
